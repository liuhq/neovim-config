...
keymap.set('i', '<C-d>', '<Del>', { remap = false, silent = true })
keymap.set('i', '<C-h>', '<BS>', { remap = false, silent = true })
keymap.set('i', '<C-n>', '<Down>', { remap = false, silent = true })
keymap.set('i', '<C-p>', '<Up>', { remap = false, silent = true })
