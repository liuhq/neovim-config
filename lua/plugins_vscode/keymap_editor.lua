...
keymap.set('n', '<leader>bt', function () vscode.call('workbench.action.openPreviousRecentlyUsedEditorInGroup') end,
    { desc = 'Switch to Other Buffer' })
keymap.set('n', '<leader>bd', function () vscode.call('workbench.action.closeActiveEditor') end,
    { desc = 'Delete Buffer' })
...
keymap.set('n', '<leader>ws', function () vscode.call('workbench.action.splitEditorDown') end,
    { desc = 'Split Window Below' })
keymap.set('n', '<leader>wv', function () vscode.call('workbench.action.splitEditorRight') end,
...
keymap.set('n', '<C-Up>', function () vscode.call('workbench.action.increaseViewHeight') end,
    { desc = 'Increase Window Height' })
keymap.set('n', '<C-Down>', function () vscode.call('workbench.action.decreaseViewHeight') end,
    { desc = 'Decrease Window Height' })
keymap.set('n', '<C-Right>', function () vscode.call('workbench.action.increaseViewWidth') end,
    { desc = 'Increase Window Width' })
keymap.set('n', '<C-Left>', function () vscode.call('workbench.action.decreaseViewWidth') end,
